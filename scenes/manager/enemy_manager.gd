...
func get_spawn_position():
	...
	for i in 4:
		# direct space state, dir of physics objects in game
		spawn_pos = player.global_position + (ran_dir * SPAWN_RADIUS)
		# 1 is the terrain layer
		...
		if result.is_empty():
			...
			ran_dir = ran_dir.rotated(deg_to_rad(90))
